...
<td className="cart__price">100TND</td>
<td className="cart__quantity">
<div className="pro-qty"><span className="dec qtybtn">-</span>
<input type="text" value="1"/>
<span className="inc qtybtn">+</span></div>
</td>
<td className="cart__total">100TND </td>
<td className="cart__close"><span class="icon_close"></span></td>
</tr>
<tr>
...
<div className="col-lg-6 col-md-6 col-sm-6" style={{marginLeft:"505px"}}>
<div className="cart__btn update__btn" style={{marginLeft:"200px"}} >
...
<div className="cart__total__procced" style={{marginLeft:"119px",width:"360px"}}>
<h6>Cart total</h6>
<ul>
